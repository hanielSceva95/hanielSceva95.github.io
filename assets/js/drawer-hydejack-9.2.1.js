...
_asyncToGenerator(function* () {
  ...
  var detectSize = () => window.matchMedia(_common__WEBPACK_IMPORTED_MODULE_2__["BREAK_POINT_DYNAMIC"]).matches ? LARGE_DESKTOP : window.matchMedia(_common__WEBPACK_IMPORTED_MODULE_2__["BREAK_POINT_3"]).matches ? DESKTOP : MOBILE;
  ...
  console.log('Drawer initialized', drawerEl, sidebarEl, contentEl);
  (_document$getElementB2 = document.getElementById('_menu')) === null || _document$getElementB2 === void 0 || _document$getElementB2.addEventListener('click', e => {
    e.preventDefault();
    e.stopPropagation();
    drawerEl.toggle();
  });
  ...
  var peekWidth$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_0__["fromEvent"])(drawerEl, 'peek-width-change').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(e => e.detail));
  ...
  var viewWidth$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_0__["fromEvent"])(window, 'resize', {
    passive: true
  }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["startWith"])({}), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(_common__WEBPACK_IMPORTED_MODULE_2__["getViewWidth"]));
  ...
  var scrollTop = Object(_common__WEBPACK_IMPORTED_MODULE_2__["getScrollTop"])();
  ...
  }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["startWith"])(opened));
  ...
  t$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["withLatestFrom"])(size$, distance$), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["tap"])(args => updateSidebar(...args))).subscribe();
...
//# sourceMappingURL=drawer-hydejack-9.2.1.js.map